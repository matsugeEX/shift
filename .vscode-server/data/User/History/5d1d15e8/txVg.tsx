...
import { AddMember,DeleteMember } from "@/Components/AddMemberButton";
  ...
  return (
    <div tabIndex={0} onKeyDown={handleKeyDown}>
      ...
      <div className="flex justify-end gap-2">
        <AddMember className="bg-blue-400 text-white px-4 py-2"></AddMember>
        <DeleteMember className="bg-red-400 text-white px-4 py-2"></DeleteMember>
      </div>
