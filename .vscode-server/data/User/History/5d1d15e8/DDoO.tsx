...
function table(){
  ...
  const [isFlase,setboolen] = useState(true);

  const bool = () => {
    setboolen(isFlase => !isFlase)
  }
      ...
      <table className="border-2 ">
        <tbody className="">
          <tr>
            ...
            <th className={`border border-red-400 text-black bg-blue-200  ${isFlase ? "bg-red-400" : "bg-blue-200"}`}>htjrt</th>
          </tr>
          <tr>
